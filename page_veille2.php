      ...
      <div class="why_container">
        <div class="box">
          <div class="detail-box">
            <h1>
                CSS et les animations Web en 3D
            </h1>
          </div>
        </div>
        <div class="box">
        ...
        <div class="boxe">
          <div class="ligne-boxe">
            ...
            <a href="https://www.smashingmagazine.com/2023/07/shines-perspective-rotations-css-3d-effects-images/" target="_blank"><p>Adresse de l'article de (Smashing Magazine)</p></a>
          </div>
        </div>
      </div>
    </div>
